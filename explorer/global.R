...
env_vars = list(
  chl     = list(
    ...
    curr_eez   = read_csv('data/eez_gl_chl_curr_09km_mo.csv')),
  seascape=list(
    legend     = 'Class',
    values     = 1:14,
    ...
    curr_eez   = read_csv('data/eez_gl_sea_curr_09km_mo.csv')),
  sst     = list(
    ...
    curr_eez   = read_csv('data/eez_gl_sst_curr_09km_mo.csv')))
